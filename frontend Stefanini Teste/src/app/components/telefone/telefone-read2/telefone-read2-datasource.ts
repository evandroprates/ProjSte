...
//  */
// export class TelefoneRead2DataSource extends DataSource<Telefone> {
//   data: Telefone[] = EXAMPLE_DATA;
...
//    */
//   private getPagedData(data: Telefone[]) {
...
//    * this would be replaced by requesting the appropriate data from the server.
//    */
//   private getSortedData(data: Telefone[]) {
